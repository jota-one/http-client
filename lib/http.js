...
function HateoasAxios(config) {
  ...
  const hateoas = {
    ...
    openBinary: (resource, rel, params, axiosConfig = {}, filename = 'document.pdf', forceDownload = false) => extended.openBinary(hateoas.resolveUri(resource, rel, params), axiosConfig, filename, forceDownload),

    downloadBinary: (resource, rel, params, axiosConfig, filename = 'document.pdf') => hateoas.openBinary(resource, rel, params, axiosConfig, filename, true),
  }
