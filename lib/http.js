...
function HateoasAxios(config) {
  ...
  const hateoas = {
    ...
    downloadBinary: (resource, rel, params, axiosConfig, filename = 'document.pdf') => extended.openBinary(hateoas.resolveUri(resource, rel, params), axiosConfig, filename, true),
  }
