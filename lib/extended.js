...
export default function ({ axiosConfig, rootEndpoint = '/index', rootIndexLinksPath = '', enableLogging = false, disableCache = false, withVerbsRestrictions = false, responseProcessors = [] }) {
    ...
    async get(hpath, params = {}, axiosOptions = {}, suffixes = []) {
      ...
      for (let module of modules) {
        ...
        result = await getCachedValue(
          ...
          prefixes,
          addSuffixes,
          disableCache || (this.cacheDisabled && (result || module))
        )
